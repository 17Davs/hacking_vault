...
![Alice encrypts the message with Bob's public key and Bob decrypts it with his private key.](Hacking%20Vault/Attachments/eac98b8e05ab4f27ab6a538b36c5d8b1.svg)

In the [Cryptography Basics](https://tryhackme.com/r/room/cryptographybasics "https://tryhackme.com/r/room/cryptographybasics") room, we explained the modulo operation and said it plays a significant role in cryptography. In the following simplified numerical example, we see the RSA algorithm in action:
